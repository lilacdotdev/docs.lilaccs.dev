    ...
    return (
      <div className="min-h-screen bg-white dark:bg-black flex items-center justify-center">
        <div className="text-center">
          <Loader2 className="w-8 h-8 text-black dark:text-white animate-spin mx-auto mb-4" />
          <p className="text-black dark:text-white">Loading post...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end gap-4 pt-6 border-t border-gray-200 dark:border-gray-800">
            ...
            <motion.button
              type="submit"
              disabled={isSaving || formData.tags.length === 0}
